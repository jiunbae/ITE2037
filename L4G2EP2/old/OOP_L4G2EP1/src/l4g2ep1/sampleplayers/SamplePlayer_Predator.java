...
/**
 * 항상 시체를 찾아 어슬렁거리는 샘플 플레이어입니다.
 * 
 * 생존자 이동: '방향 섞기' 기능으로 만들어 둔 순서에 따라 4턴을 한 주기로 두고 반복적으로 비슷한 자리를 맴돕니다.
 * 감염체 이동: 현 위치에 시체가 있는 경우 제자리에 머무릅니다. 그렇지 않은 경우 생존자 및 시체가 가장 많은 방향으로 이동합니다.
 ...
 *
 */
public class SamplePlayer_Predator extends Player
{
	/**
	 ...
	 */
	public SamplePlayer_Predator(int ID)
	{
		name = String.format("포식자#%d", ID);
